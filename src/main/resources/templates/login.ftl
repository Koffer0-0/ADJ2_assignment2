                                    ...
                                    <div>
                                        <form class="theme-form" method="POST" action="/login">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" style="background: white" name="username"
                                                       type="text" required=""/>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-form-label">Password</label>
                                                <input class="form-control" style="background: white" name="password"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="text-left mt-2 m-l-20">Are you already user?  <a
                                                            class="btn-link text-capitalize" style="color: orangered"
